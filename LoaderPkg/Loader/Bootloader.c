...
/*#if 1 ///< Uncomment to await debugging
  ...
  DEBUG ((DEBUG_INFO, "JOS: PCI Vendor ID: %u\n", PciRead32(0x0) >> 16));
  DEBUG ((DEBUG_INFO, "JOS: PCI Device ID: %u\n", PciRead16(0x0)));
  DEBUG ((DEBUG_INFO, "JOS: PCI Header Type: 0x%x\n", PciRead32(0xC)));
  DEBUG ((DEBUG_INFO, "JOS: info1: %x\n", PciRead16(0x4)));
  DEBUG ((DEBUG_INFO, "JOS: info2: %x\n", PciWrite16(0x4, PciRead16(0x4) | 0x20)));
  DEBUG ((DEBUG_INFO, "JOS: info3: %x\n", PciRead16(0x4)));
